...
<body>
	...
	<form method="POST">
		...
		<input
			id="On Left" type="button" value="On Left"
			onclick="common_post('On Left', 'status2');"> <input id="Off Left"
			type="button" value="Off Left" onclick="common_post('Off Left', 'status3');"><input
			id="On Right" type="button" value="On Right"
			onclick="common_post('On Right', 'status16');"> <input id="Off Right"
			type="button" value="Off Right"
			onclick="common_post('Off Right', 'status17');"> <input
			...
			onclick="common_post('RBedOff', 'status7');"> <input name="Ap8"
			id="Read" type="button" value="Read Left"
			onclick="common_post('Read Left',  'status8');"> <input
			id="Read Right" type="button" value="Read Right"
			onclick="common_post('Read Right',  'status18');">  
