...
<body>
	...
	<form method="POST">
		...
		<input
			...
			onclick="common_post('Table',  'status9');"><input name="Ap10"
			id="Decor" type="button" value="Decor"
			onclick="common_post('Decor',  'status10');"><br><br>
		<input id="On 1" type="button" value="On 1"
		onclick="common_post('On 1', 'status11');">
		<input id="Off 1" type="button" value="Off 1"
		onclick="common_post('Off 1', 'status12');">	
		<input id="Decor 1" type="button" value="Decor 1"
		onclick="common_post('Decor 1', 'status13');">	
